package aixiya.framework.backend.architecture.gateway.handler;
 ...
 */
@Slf4j
public class AixiyaGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public AixiyaGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
